...
## Mostrare le regole di port forwarding della macchina virtuale
`vboxmanage showvminfo "nome_macchina_virtuale" | grep "Rule("`

`vboxmanage modifyvm "nome_macchina_virtuale" --natpf1 "nome_regola"`
## Controllare la macchina virtuale
Alcuni comandi disponibili sono pause, resume, reset, poweroff e savestate
